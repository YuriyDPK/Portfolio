  ...
  return (
    <main className="relative h-[210vh]  tablet:h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div
          className={clsx(
            "absolute top-200  tablet:top-1/4 w-full desktop2:w-2/3 desktop2:left-[13em] left-auto  flex justify-center flex-col bg-white border rounded-lg p-6 transition-transform duration-1000 ease-out",
            {
              "translate-y-full opacity-0": !isLoaded,
              "translate-y-0 opacity-100": isLoaded,
            }
        ...
        >
          <h3 className="text-[1.1em] text-left font-semibold mb-4">
            Добро пожаловать на мой сайт! Меня зовут Юрий, и я вижу в
            веб-программировании и дизайне не только профессию, но и искусство.
            Я стремлюсь создавать уникальные и инновационные веб-решения,
            которые не только эстетически приятны, но и функциональны. Моя
            страсть к технологиям и креативному процессу позволяет мне воплощать
            ваши идеи в реальность, обеспечивая при этом высокий уровень
            профессионализма и качества. Я постоянно совершенствую свои навыки и
            следую последним тенденциям в веб-разработке и дизайне, чтобы
            обеспечить моим клиентам только лучшие решения. Мой опыт включает в
            себя работу с различными технологиями, такими как HTML, CSS,
            JavaScript, а также фреймворками и библиотеками, такими как React,
            Vue.js и Laravel. Кроме того, я имею глубокое понимание принципов
            дизайна и опыт работы с инструментами для создания уникальных
            пользовательских интерфейсов. Я готов взяться за любой проект, будь
            то создание корпоративного веб-сайта, интернет-магазина или
            веб-приложения. Свяжитесь со мной, и давайте вместе создадим что-то
